  ...
  return (
    <div className="bg-[white] flex justify-center items-center flex-col rounded-[10px] sm:p-10 p-4 shadow-lg">
      ...
      <p className="font-epilogue justify-left font-semibold text-[14px] leading-[30px] text-[#818183]">
           "Prior to creating a campaign, KYC verification is mandatory."
          </p>
          
      <div className="flex justify-center items-center p-[16px] sm:min-w-[380px] bg-[#8f0183] rounded-[10px] shadow-md drop-shadow-2xl">
      ...
      <form onSubmit={handleSubmit} className="w-full mt-[65px] flex flex-col gap-[30px]">
        ...
        <FormField 
          ...
          <FormField 
            ...
            placeholder="Adhar number should be 12 digit"
            inputType="number"
            value={form.adharNum}
            handleChange={(e) => handleFormFieldChange('adharNum', e)}
          />
